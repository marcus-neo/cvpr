...
def correspondences_automation(
    ...
    :param filepath1: The path to the first image.
    :param filepath2: The path to the second image.
    ...
    """
    # Reading the images
    img1_og = cv2.imread(filepath1)
    img2_og = cv2.imread(filepath2)

    # Convert the images to grayscale
    img1 = cv2.cvtColor(img1_og, cv2.COLOR_BGR2GRAY)  # queryImage
    img2 = cv2.cvtColor(img2_og, cv2.COLOR_BGR2GRAY)  # trainImage
